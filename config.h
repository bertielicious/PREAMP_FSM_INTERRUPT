...
#define LED PORTCbits.RC1       // GREEN LED output pin 15 
...
bool button_stateCLK = 1;     // button_state is the debounced output of CLK or SWIP of rotary encoder
bool button_stateDT = 1;     // button_state is the debounced output of DT or SWIP of rotary encoder
uchar status = off;
uchar rot_encoder = 0;
